package com.one.digitalinnovation.citiesapi.cities.entities;
...
public class City {
    ...
    private Point location; //Ponto cartesiano (latitude e longitude);
    ...
    public Point getLocation() { return location; } //Mostra os x e y;
}